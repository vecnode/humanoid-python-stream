...
Text-to-motion simulation. Combines [CLoSD](https://github.com/GuyTevet/CLoSD), [Isaac Gym](https://developer.nvidia.com/isaac-gym), and [PilotLight](https://github.com/PilotLightTech/pilotlight) through a bridge so prompts can drive a humanoid and stream the state to a real-time viewer.
...
- DiP diffusion planner
        `CLoSD/closd/diffusion_planner/save/DiP_no-target_10steps_context20_predict40/model000200000.pt`
        - Creates future motion from text
- CLoSD RL policy
        `CLoSD/output/CLoSD/CLoSD_t2m_finetune/Humanoid.pth`
        - Tracks planned motion with physics control
- SMPL body model
        `CLoSD/closd/diffusion_planner/body_models/smpl/SMPL_NEUTRAL.pkl`
        - Body representation used in planning and control
